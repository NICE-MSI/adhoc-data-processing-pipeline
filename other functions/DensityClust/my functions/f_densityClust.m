function [numClust, clustInd, centInd, haloInd, delta] = f_densityClust(dist, dc, rho, isHalo, isManualSelect)
...
%       haloInd: haloInd row vector [0 denotes no haloInd assignment]
    ...
    [numClust, centInd, h] = f_decisionGraph(rho, delta, isManualSelect); % isManualSelect = 1 denote that all the cluster centroids are selected manually, otherwise 0
